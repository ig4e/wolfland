...
function Navbar() {
  ...
  const user: { name: string; email: string; image: string } =
    session?.user as any;
  ...
  return (
    <nav className="relative h-[55px] md:h-[75px]">
      <div className="fixed inset-x-0 top-0 z-50 flex h-[55px] items-center justify-center bg-root opacity-90 backdrop-blur-lg md:h-[75px]">
            ...
            {user ? (
              ...
              >
                <DropdownMenu.Trigger asChild>
                  <button
                    dir="ltr"
                    className="flex items-center gap-1  rounded-md p-1 transition hover:bg-root-100 active:bg-root-200"
                  >
                    <img
                      src={user.image}
                ...
                <AnimatePresence>
                  {menuOpen && (
                    <DropdownMenu.Portal forceMount={true}>
                      <DropdownMenu.Content forceMount={true} asChild>
      ...
      <div className="fixed inset-x-0 top-0 z-40 h-[55px] backdrop-blur md:h-[75px]"></div>
